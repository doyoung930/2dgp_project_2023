...
class M2:
    ...
    def update(self):
        self.frame = (self.frame + FRAMES_PER_M2_ACTION * ACTION_PER_TIME * game_framework.frame_time) % FRAMES_PER_M2_ACTION
        self.bt.run()
...
class M3:
    ...
    def update(self):
        self.frame = (self.frame + FRAMES_PER_M3_ACTION * ACTION_PER_TIME * game_framework.frame_time) % FRAMES_PER_M3_ACTION
        self.bt.run()
...
class M4:
    ...
    def update(self):
        self.frame = (self.frame + FRAMES_PER_M4_ACTION * ACTION_PER_TIME * game_framework.frame_time) % FRAMES_PER_M4_ACTION
        self.bt.run()
...
class M5:
    ...
    def update(self):
        self.frame = (self.frame + FRAMES_PER_M5_ACTION * ACTION_PER_TIME * game_framework.frame_time) % FRAMES_PER_M5_ACTION
        self.bt.run()
